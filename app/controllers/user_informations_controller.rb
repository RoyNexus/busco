class UserInformationsController < ApplicationController
  ...
  private
    ...
    def user_information_params
      params.require(:user_information).permit(:name, :family_members, :family_description, :pets, :pets_description, :family_workers, :workers_description, :principal_phone, :secondary_phone, :secondary_email, :user_id)
    end
end
